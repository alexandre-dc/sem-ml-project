...
for _ in range(1):
    for alg in list_alg:
        for i in range(1, 4):
            ...
            fw = open('/home/alexandre/sem-project-logs/minimax/board_nextMoves_' + str(sem_game.MAX_MOVES) + "_" + str(sem_game.BOARD_ROWS) + "x" + str(sem_game.BOARD_COLS) + "_" + "MMPSC", 'wb')
