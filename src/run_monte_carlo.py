...
for n_search in n_search_lst1:
    for i in range(attemps):
        ...
        error, total_reward, dict_size = monte_carlo.test_MC(f_results, int(n_tests), dict_canonic_states)      # Testing processe
...
fw = open('/home/alexandre/sem-project-logs/monte_carlo/policy_sem1_3_2_' + _type + '_' + str(int(n_search_lst1[0]/1000)) + 'k_f_results', 'wb')
pickle.dump(f_results, fw)
fw.close()
fw = open('/home/alexandre/sem-project-logs/monte_carlo/policy_sem1_3_2_' + _type + '_' + str(int(n_search_lst1[0]/1000)) + 'k_dcs', 'wb')
